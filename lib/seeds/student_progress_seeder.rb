module StudentProgressSeeder
  ...
  def self.generate_progress_entry(date, phase, language_records, area_records, value)
    {
      date: date,
      mark: phase,
  ...
  def self.generate_phase_progress_entries(values, params)
    values.each_with_index.map do |value, i|
      ...
      generate_progress_entry(date, params[:phase], params[:language_records], params[:area_records], value)
    end
  end
