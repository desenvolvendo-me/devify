...
%o`, message, error2, detail);
  ...
  var me = class extends ee {
    ...
    createNodes() {
      ...
      for (let r3 = 0; r3 < e2.length; r3++) {
        const o2 = e2[r3], s2 = {};
        0 === r3 && (s2.isFirst = true), r3 === i2 && (s2.isLast = true), pe(n2) && (s2.followsWhitespace = true);
  ...
  var Be = class extends nt {
    ...
    splitObjectsAtRange(t2) {
      let e2, [i2, n2, r3] = this.splitObjectAtPosition(Pe(t2));
      return [i2, e2] = new this.constructor(i2).splitObjectAtPosition(Ie(t2) + r3), [i2, n2, e2 - 1];
    }
  ...
  var je = function(t2) {
    ...
    return r3 ? (n2 = n2.map((t3) => t3.isBlockBreak() ? (e2 = true, Ve(t3)) : t3), e2 ? new Ne([...n2, r3]) : t2) : t2;
  };
  ...
  var Je = class extends nt {
    ...
    insertBlockBreakAtRange(t2) {
      ...
      return 0 === n2 && (e2 = [new Oe()]), new this.constructor(r3.blockList.insertSplittableListAtPosition(new Be(e2), i2));
    }
    ...
    getCommonAttributesAtPosition(t2) {
      ...
      if (!o2)
        return {};
      const s2 = Ke(o2), a2 = o2.text.getAttributesAtPosition(r3), l2 = o2.text.getAttributesAtPosition(r3 - 1), c2 = Object.keys(W).filter((t3) => W[t3].inheritable);
      for (e2 in l2)
  ...
  var gi = class extends H {
    ...
    loadSnapshot(t2) {
      ...
      return null === (e2 = this.delegate) || void 0 === e2 || null === (i2 = e2.compositionWillLoadSnapshot) || void 0 === i2 || i2.call(e2), this.setDocument(null != o2 ? o2 : new Je()), this.setSelection(null != s2 ? s2 : [0, 0]), null === (n2 = this.delegate) || void 0 === n2 || null === (r3 = n2.compositionDidLoadSnapshot) || void 0 === r3 ? void 0 : r3.call(n2);
    }
    insertText(t2) {
  ...
  Re(on, "events", { keydown(t2) {
    ...
    if (i2) {
      ...
      n3 = o3 ? qt(o3).trim() : i2, e2.html = this.createLinkHTML(i2, n3), null === (r3 = this.delegate) || void 0 === r3 || r3.inputControllerWillPaste(e2), this.withTargetDOMRange(function() {
        var t3;
